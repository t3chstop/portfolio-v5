...
export function Header() {
    ...
    return (
            <Box textAlign='left' pt={[10, 10, 10, 36]} pl={[0, 10, 20]} pr='10'>
                <Heading as='h1' fontWeight='bold' fontSize={['5.5rem', '5.5rem', '8xl']} color='white'>Hey, I'm <Heading as='span' fontWeight='bold' fontSize={['5.5rem', '5.5rem', '8xl']} color='blue.400'>Siddarth</Heading></Heading>
